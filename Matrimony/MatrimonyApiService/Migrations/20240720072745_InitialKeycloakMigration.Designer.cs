...
namespace MatrimonyApiService.Migrations
{
    ...
    [Migration("20240720072745_InitialKeycloakMigration")]
    partial class InitialKeycloakMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatrimonyApiService.AddressCQRS.Address", b =>
                {
                    b.HasOne("MatrimonyApiService.User.User", "User")
                        .WithOne("Address")
                        .HasForeignKey("MatrimonyApiService.AddressCQRS.Address", "UserId")
            ...
            modelBuilder.Entity("MatrimonyApiService.Message.Message", b =>
                {
                    b.HasOne("MatrimonyApiService.Chat.Chat", "Chat")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("MatrimonyApiService.ProfileView.ProfileView", b =>
                {
                    ...
                    b.HasOne("MatrimonyApiService.Profile.Profile", "Viewer")
                        .WithMany("Views")
            ...
            modelBuilder.Entity("MatrimonyApiService.Staff.Staff", b =>
                {
                    b.HasOne("MatrimonyApiService.AddressCQRS.Address", "Address")
                        .WithMany()
