...
namespace MatrimonyApiService.Migrations
{
    ...
    [Migration("20240524170756_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatrimonyApiService.Match.Match", b =>
                {
                    ...
                    b.Property<int>("ProfileOneId")
                        .HasColumnType("int");

                    b.Property<bool>("ProfileOneLike")
                        .HasColumnType("bit");

                    b.Property<int>("ProfileTwoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MatrimonyApiService.Match.Match", b =>
                {
                    b.HasOne("MatrimonyApiService.Profile.Profile", "ProfileOne")
                        .WithMany("Matches")
                        .HasForeignKey("ProfileOneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MatrimonyApiService.Profile.Profile", "ProfileTwo")
                        .WithMany()
