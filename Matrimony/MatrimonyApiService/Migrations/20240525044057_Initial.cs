        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SentProfileId = table.Column<int>(type: "int", nullable: false),
                    ProfileOneLike = table.Column<bool>(type: "bit", nullable: false),
                    ReceivedProfileId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Matches_Profiles_ReceivedProfileId",
                        column: x => x.ReceivedProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Matches_Profiles_SentProfileId",
                        column: x => x.SentProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_ReceivedProfileId",
                table: "Matches",
                column: "ReceivedProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_SentProfileId",
                table: "Matches",
                column: "SentProfileId");
