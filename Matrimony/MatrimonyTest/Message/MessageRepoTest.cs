        ...
        public class MessageRepoTest
        {
            ...
            public async Task GetAll_ShouldReturnAllEntities()
            {
                ...
                await _context.Messages.AddRangeAsync(
                    new MatrimonyApiService.Message.Message { SenderId = 1, ReceiverId = 2, SentAt = DateTime.Now, Seen = false },
                    new MatrimonyApiService.Message.Message { SenderId = 2, ReceiverId = 1, SentAt = DateTime.Now, Seen = true }
                );
                await _context.SaveChangesAsync();
