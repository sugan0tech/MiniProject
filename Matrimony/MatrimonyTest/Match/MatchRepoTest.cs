...
namespace MatrimonyTest.Match
{
        ...
        public class MatchRepoTests
        {
            ...
            {
                // Arrange
                var match = new MatrimonyApiService.Match.Match { SentProfileId = 1, ReceivedProfileId = 2, ProfileOneLike = true, ProfileTwoLike = false, Level = 3, FoundAt = DateTime.Now };
            ...
            public async Task GetAll_ShouldReturnAllEntities()
            {
                ...
                await _context.Matches.AddRangeAsync(
                    new MatrimonyApiService.Match.Match { SentProfileId = 1, ReceivedProfileId = 2, ProfileOneLike = true, ProfileTwoLike = false, Level = 3, FoundAt = DateTime.Now },
                    new MatrimonyApiService.Match.Match { SentProfileId = 3, ReceivedProfileId = 4, ProfileOneLike = false, ProfileTwoLike = true, Level = 4, FoundAt = DateTime.Now }
                );
                await _context.SaveChangesAsync();
            ...
            {
                // Arrange
                var updateMatch = new MatrimonyApiService.Match.Match { Id = 99, SentProfileId = 1, ReceivedProfileId = 2, ProfileOneLike = true, ProfileTwoLike = false, Level = 3, FoundAt = DateTime.Now };
